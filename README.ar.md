...
**الطازجة HTTP / HTTPS / SOCKS4 / SOCKS5** بالتوازي من مئات نقاط النهاية
العامة المُنتقاة، ويُسقط تلقائياً المصادر القديمة، ويزيل التكرار، ويتحقق
من الصحة، ثم يُخرج قائمة `IP:PORT` نظيفة ومُرتَّبة.
