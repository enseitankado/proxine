...
case $arg in
   "http")
	...
	echo "\n"
	curl -s "https://raw.githubusercontent.com/fate0/proxylist/master/proxy.list" | python parsefate0.py http
       ;;
   "https")
	echo "\n"
	...
	curl -s "https://raw.githubusercontent.com/saschazesiger/Free-Proxies/master/proxies/premium.txt"
	echo "\n"
	curl -s "https://raw.githubusercontent.com/fate0/proxylist/master/proxy.list" | python parsefate0.py https
	;;
   "socks4")
	echo "\n"
